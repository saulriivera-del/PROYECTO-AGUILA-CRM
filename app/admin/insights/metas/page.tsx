...
export default async function GoalsPage({searchParams}:{searchParams:SearchParams}) {
  ...
  return <>
    <header className="insights-hero compact"><div><span className="eyebrow">Águila Insights · Fase 5.2.2</span><h1>Centro de Metas</h1><p>Define objetivos medibles para Visa Master y para cada integrante del equipo.</p></div></header>

...
export default async function FinanceInsightsPage() {
  ...
  return <>
    <header className="insights-hero compact">
      <div><span className="eyebrow">Águila Insights · Fase 5.2 Final</span><h1>Centro Financiero</h1><p>Lectura ejecutiva basada únicamente en dinero efectivamente cobrado.</p></div>
    </header>

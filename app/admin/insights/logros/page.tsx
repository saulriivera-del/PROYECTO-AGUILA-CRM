...
export default async function AchievementsPage(){
 ...
 return <>
  <header className="insights-hero compact"><div><span className="eyebrow">Águila Insights · Fase 5.2 Final</span><h1>Logros del equipo</h1><p>Reconocimientos automáticos basados en resultados reales del CRM.</p></div><Link className="secondary-button" href="/admin/insights">Volver a Insights</Link></header>
